...
void main() {
	...
	`}var vs=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $i(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var ad=[{acronym:`ARC FTKPM`,name:`Autonomous, Robotic and Control`,description:`Specializes in autonomous systems, path planning, and advanced vehicle dynamics.`,members:[`Assoc. Prof. Ts. Dr. Muhammad Aizzat Bin Zakaria`,`Dr. Ismayuzri Bin Ishak`],icon:`fa-robot`},{acronym:`IMAMS Lab`,name:`Innovative, Manufacturing, Mechatronics`,description:`Focuses on mechatronic system design, smart manufacturing, and AI integration.`,members:[`Dr. Mohd Azraai Bin Mohd Razman`,`Mr. Wan Hasbullah Bin Mohd Isa`],icon:`fa-microchip`},{acronym:`EMDL Lab`,name:`Electromechanical Drivetrain Laboratory`,description:`Research in electric motor drives, fault detection, and electromechanical actuators.`,members:[`Dr. Mohd Azri Hizami Bin Rasid`],icon:`fa-cogs`},{acronym:`RMRL`,name:`Robot Mechanism Research Lab`,description:`Dedicated to kinematics, assistive robotics, and dynamic control of robotic arms.`,members:[`Dr. Ahmad Najmuddin Bin Ibrahim`,`Ts. Dr. Sheikh Muhammad Hafiz Fahami Bin Zainal`],icon:`fa-drafting-compass`},{acronym:`HTFFM Lab`,name:`Heat Transfer, Fluid Flow, Manufacturing`,description:`Expertise in thermofluid process control, CFD, and advanced manufacturing.`,members:[`Assoc. Prof. Dr. Abdul Aziz Bin Jaafar`],icon:`fa-fire-alt`}],od=document.getElementById(`labs-container`);od&&ad.forEach((e,t)=>{let n=t*.1,r=document.createElement(`div`);r.className=`lab-card-3d`,r.style.animation=`fadeInUp 0.6s ease-out ${.2+n}s forwards`,r.style.opacity=`0`,r.innerHTML=`
    ...
    `,od.appendChild(r)});var sd=[{name:`Assoc. Prof. Dr. Abdul Aziz Bin Jaafar`,title:`Head of Cluster`,tags:[`P04`],image:`/members/pm-aziz-7.jpg`,about:`Expert in industrial mechatronics, advanced manufacturing, and thermofluid process control.`},{name:`Assoc. Prof. Ts. Dr. Muhammad Aizzat Bin Zakaria`,title:`Researcher`,tags:[`P01`,`P02`],image:`/members/aizzat.jpeg`,website:`https://www.maizzat.my`,about:`Specializes in autonomous vehicles, mobile robotics, SLAM, and intelligent assistive technologies.`},{name:`Dr. Ahmad Najmuddin Bin Ibrahim`,title:`Researcher`,tags:[`P02`],image:`/members/najmuddin.jpg`,website:`https://blog.ump.edu.my/anajmuddin/`,about:`Focuses on intelligent robotics, kinematics, and dynamic control of robotic systems.`},{name:`Dr. Mohd Azri Hizami Bin Rasid`,title:`Researcher`,tags:[`P03`],image:`/members/azri.jpg`,website:`https://sites.google.com/ump.edu.my/mahrasid/home?pli=1`,about:`Research interests include electric motor drives, electromechanical actuators, and fault detection.`},{name:`Ts. Dr. Sheikh Muhammad Hafiz Fahami Bin Zainal`,title:`Researcher`,tags:[`P03`],image:`/members/hafiz-21.jpg`,website:`https://scholar.google.com/citations?user=z6j75UsAAAAJ&hl=en`,about:`Expertise in drive systems, thermal modelling, and dynamic control engineering.`},{name:`Dr. Ismayuzri Bin Ishak`,title:`Researcher`,tags:[`P03`,`P04`],image:`/members/ismayuzri-1.jpg`,website:`https://scholar.google.com/citations?user=T3IxOdwAAAAJ&hl=en`,about:`Works on advanced actuators, smart industrial systems, and computational fluid dynamics.`},{name:`Dr. Mohd Azraai Bin Mohd Razman`,title:`Researcher`,tags:[`P04`],image:`/members/dr-azraai-5.jpg`,website:`https://imamslab.umpsa.edu.my/index.php/en/about-us/people`,about:`Specializes in smart systems, mechatronic design, and sustainable manufacturing processes.`},{name:`Mr. Wan Hasbullah Bin Mohd Isa`,title:`Researcher`,tags:[`P04`],image:`/members/wan-hasbullah-12.jpg`,website:`https://imamslab.umpsa.edu.my/index.php/en/about-us/people`,about:`Focuses on industrial mechatronics, automation, and intelligent process control.`}],cd=document.querySelector(`.researchers-grid`),ld=document.getElementById(`researchers-dropdown`),ud=``,dd=``;sd.forEach((e,t)=>{let n=e.name.split(` `).map(e=>e[0]).slice(0,2).join(``),r=e.image?e.image:`https://placehold.co/400x400/184A92/FFFFFF?text=${n}`,i=`researcher-${t}`;ud+=`<a href="#${i}">${e.name}</a>`,dd+=`
  ...
  `}),cd.innerHTML=dd,ld&&(ld.innerHTML=ud),(()=>{let e=document.getElementById(`canvas-container`),t=new jn;t.background=new X(`#0A0A0A`),t.fog=new An(657930,.015);let n=new lo(60,window.innerWidth/window.innerHeight,.1,1e3);n.position.set(0,5,40);let r=new nu({antialias:!0,alpha:!0});r.setSize(window.innerWidth,window.innerHeight),r.setPixelRatio(Math.min(window.devicePixelRatio,2)),r.toneMapping=4,r.toneMappingExposure=1,e.appendChild(r.domElement);let i=new vo(16777215,.4);t.add(i);let a=new _o(41634,3);a.position.set(15,20,10),t.add(a);let o=new mo(1591954,4,60);o.position.set(-15,5,10),t.add(o);let s=new _o(16777215,1);s.position.set(-10,0,-10),t.add(s);let c=new va({color:1591954,emissive:41634,emissiveIntensity:.4,wireframe:!0,transparent:!0,opacity:.3,blending:2,depthWrite:!1}),l=new va({color:663099,emissive:17476,emissiveIntensity:.25,wireframe:!0,transparent:!0,opacity:.25,blending:2,depthWrite:!1}),u=new ou,d;u.load(`/robot_arm.glb`,e=>{d=e.scene,d.scale.set(15,15,15),d.position.set(0,-15,-10),d.traverse(e=>{e.isMesh&&(e.material=l)}),t.add(d)});let f=(()=>{let e=new Sn,t=new Zr(new ra(4,1.5,6),c);t.position.y=1,e.add(t);let n=new ia(1,1,.8,32);n.rotateZ(Math.PI/2),[[-2.2,1,2],[2.2,1,2],[-2.2,1,-2],[2.2,1,-2]].forEach(t=>{let r=new Zr(n,c);r.position.set(...t),e.add(r)});let r=new Zr(new ia(.5,.5,1,16),new va({color:16777215,emissive:65535,emissiveIntensity:1,wireframe:!0,transparent:!0,opacity:.9,blending:2}));r.position.set(0,2.25,1),r.name=`lidar`;let i=new ia(15,.1,60,32);i.rotateX(Math.PI/2),i.translate(0,0,30);let a=new Zr(i,new zr({color:65535,transparent:!0,opacity:.15,blending:2,depthWrite:!1,side:2}));return r.add(a),e.add(r),e})();f.position.set(12,-8,-15),t.add(f);let p=new Sn;for(let e=0;e<30;e++){let e=4+Math.random()*8,t=10+Math.random()*40,n=new Zr(new ra(e,t,4+Math.random()*8),c),r=(Math.random()-.5)*150,i=-40-Math.random()*40;n.position.set(r,t/2-15,i),p.add(n)}t.add(p);let m=[],h=new Tr,g=new Float32Array(450);for(let e=0;e<150;e++){let t=(Math.random()-.5)*100,n=(Math.random()-.5)*100,r=(Math.random()-.5)*50-20;g[e*3]=t,g[e*3+1]=n,g[e*3+2]=r,m.push({velocity:new G((Math.random()-.5)*.08,(Math.random()-.5)*.08,(Math.random()-.5)*.08)})}h.setAttribute(`position`,new ur(g,3));let _=new Zi(h,new Ki({color:65535,size:.3,transparent:!0,opacity:.8,blending:2}));t.add(_);let v=new Mi({color:1591954,transparent:!0,opacity:.25,blending:2}),y=new Wi(new Tr,v);t.add(y);let b=0,x=0,S=window.innerWidth/2,C=window.innerHeight/2;document.addEventListener(`mousemove`,e=>{b=e.clientX-S,x=e.clientY-C});let w=window.scrollY;window.addEventListener(`scroll`,()=>{w=window.scrollY}),window.addEventListener(`resize`,()=>{n.aspect=window.innerWidth/window.innerHeight,n.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)});let T=new Ro,E=0,D=()=>{requestAnimationFrame(D);let e=T.getElapsedTime();e-E,E=e;let i=b*.002,a=x*.002;if(d){d.rotation.y=i*.2,d.rotation.x=a*.2,d.position.y=-15;let e=Math.max(1.5,15-w*.015);d.scale.set(e,e,e),d.position.z=-10-w*.04}if(f){let t=.08;f.position.x=Math.sin(e*t)*35,f.position.z=-20+Math.cos(e*t)*15;let n=Math.cos(e*t)*35,r=-Math.sin(e*t)*15;f.rotation.y=Math.atan2(n,r)+Math.PI;let i=f.getObjectByName(`lidar`);i&&(i.rotation.y+=.02),f.children.forEach(e=>{e.geometry.type===`CylinderGeometry`&&e.name!==`lidar`&&(e.rotation.x+=.1)})}n.position.y=5-w*.02,n.lookAt(0,0,0);let o=_.geometry.attributes.position.array,s=[];for(let e=0;e<150;e++){let t=m[e];o[e*3]+=t.velocity.x,o[e*3+1]+=t.velocity.y,o[e*3+2]+=t.velocity.z,(o[e*3]>50||o[e*3]<-50)&&(t.velocity.x*=-1),(o[e*3+1]>50||o[e*3+1]<-50)&&(t.velocity.y*=-1),(o[e*3+2]>10||o[e*3+2]<-50)&&(t.velocity.z*=-1);for(let t=e+1;t<150;t++){let n=o[e*3]-o[t*3],r=o[e*3+1]-o[t*3+1],i=o[e*3+2]-o[t*3+2];n*n+r*r+i*i<225&&s.push(o[e*3],o[e*3+1],o[e*3+2],o[t*3],o[t*3+1],o[t*3+2])}}_.geometry.attributes.position.needsUpdate=!0,y.geometry.setAttribute(`position`,new pr(s,3)),r.render(t,n)};D()})();